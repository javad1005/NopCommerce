...
namespace Nop.Services.Catalog
{
    ...
    public partial class PriceFormatter : IPriceFormatter
    {
            ...
            bool showCurrency, Currency targetCurrency)
        {
            ...
            string result;
            //NopComents add amount = decimal.Round(amount, 4);
            ...
            else
            {
                ...
                else
                {
                    ...
                    //NopComents result = $"{amount:N0} ({targetCurrency.CurrencyCode})";
                    result = $"{amount:N0} {targetCurrency.CurrencyCode}";
                    return result;
                }
            }
            ...
            {
                //NopComents result = $"{result} ({targetCurrency.CurrencyCode})";
